package com.gzeinnumer.getpermissionv2;
...
import com.gzeinnumer.getpermissionv2.databinding.ActivityMainBinding;
import com.gzeinnumer.getpermissionv2.helper.FileCompressorV2;
...
public class MainActivity extends AppCompatActivity implements PickiTCallbacks  {
    ...
    private FileCompressorV2 fileCompressorV2;
    private PickiT pickiT;
    private String TAG = getClass().getSimpleName();
    private File mPhotoAsset;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileCompressorV2 = new FileCompressorV2(this);
        /**
        ...
        fileCompressorV2.setDestinationDirectoryPath(path);
        onClick();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO_CAMERA) {
            try {
                mPhotoAsset = fileCompressorV2.compressToFile(mPhotoAsset);
